    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?= base_url('Welcome/gallery')?>">Gallery</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Our Products Collection</h1>
            <span class="color-text-a">Koleksi mukenah dan sarung yang duduk</span>
          </div>
        </div>
      ...
      <div class="row">
          ...
          <div class="grid-option">
            <form>
              <select class="custom-select">
                ...
                <option value="3">Tertajir</option>
              </select>
            </form>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="<?= base_url('assets')?>/img/property-1..jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="#">Mukenah dannis
                      <br /> anak-anak</a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Beli | Rp220.000</span>
                  </div>
                ...
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    <li>
                      <h4 class="card-info-title">Stock</h4>
                      <span>340
                      </span>
                    </li>
                    <li>
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="<?= base_url('assets')?>/img/property-3..jpg" style="width: 340px;"alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Beli | Rp312.000</span>
                  </div>
                  <a href="property-single.html" class="link-a">Click here to view
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="<?= base_url('assets')?>/img/property-6..jpg" alt="" style="width: 600px;"class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="#">Sarung dewasa
                                            <br /> Tosca</a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Beli | RP52.000</span>
                  </div>
                  <a href="property-single.html" class="link-a">Click here to view
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="<?= base_url('assets')?>/img/property-7..jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Beli | Rp62.000</span>
                  </div>
                  <a href="property-single.html" class="link-a">Click here to view
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="<?= base_url('assets')?>/img/property-8" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="<?= base_url('assets')?>/img/property-10..jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                ...
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">Beli | Rp72.000</span>
                  </div>
                  <a href="property-single.html" class="link-a">Click here to view
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
        ...
        <div class="col-md-12">
          <nav class="nav-footer">
            <ul class="list-inline">
              ...
              <li class="list-inline-item">
                <a href="<?= base_url('Welcome/gallery')?>">About</a>
              </li>
              <li class="list-inline-item">
                <a href="<?= base_url('Welcome/index')?>">Property</a>
              </li>
              <li class="list-inline-item">
                <a href="<?= base_url('Welcome/index')?>">Gallery</a>
              </li>
              <li class="list-inline-item">
